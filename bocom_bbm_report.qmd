...
# Detalhes da Operação e Matrículas

Esta seção apresenta os dados gerais da operação de crédito rural e os detalhes de cada empreendimento financiado, incluindo as informações das matrículas associadas (CAR, NIRF) e os cronogramas agrícolas.
...
# Example: general info table
if "general_info" in parsed_data:
    # Convert dict to list of [attribute, value]
    table_data = [[k, v] for k, v in parsed_data["general_info"].items()]

...
if __name__ == "__main__":
    ...
    colecao_modis = 'MOD13Q1-6'  # Ajuste se necessário
    servico_wtss = wtss.WTSS(bdc_wtss_link)
    cubo = servico_wtss[colecao_modis]

    # Solicitar WKT do usuário
    wkt_input = input("Digite a geometria WKT (ex: POLYGON((-47.0 -22.0, -47.0 -21.0, -46.0 -21.0, -46.0 -22.0, -47.0 -22.0))): ")
    ...
    # Chamar a função
    fig = get_and_plot_areal_ts_wtss(cubo, gleba_4326, gleba_id, planting_period, harvesting_period)
